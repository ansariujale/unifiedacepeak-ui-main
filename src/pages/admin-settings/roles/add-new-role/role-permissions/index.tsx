...
export const PermissionsAccordion = ({
  ...
  return (
    <>
      {/* The caveat that used to sit here as a paragraph — permissions decide
          what this app shows, not what the platform allows — now lives in the
          info tooltip next to "Select a role to use as a starting point."
          above (select-role/index.tsx), so the four screens that carry it
          (this one, the capability table, Admin scope, Default permissions)
          still say the same thing, just without eating vertical space here. */}
      <Accordion
        type="multiple"
        value={openItems}
