  ...
  return (
    ...
    >
      ...
      <Dialog open={Boolean(adminNotification)}>
        ...
        >
          <div className="relative overflow-hidden bg-gradient-to-br from-red-600 via-rose-600 to-red-800 px-6 py-7 text-white">
            ...
            <div className="relative flex items-start gap-4">
              ...
              <div className="min-w-0 flex-1">
                <p className="mb-1 text-xs font-semibold uppercase tracking-[0.18em] text-red-100">
                  Product update
                </p>
          ...
          <div className="px-6 py-6">
            ...
            <div className="mt-5 rounded-xl border border-red-100 bg-red-50/70 px-4 py-3 dark:border-red-900/60 dark:bg-red-950/30">
              <p className="text-xs font-medium leading-5 text-red-800 dark:text-red-300">
      ...
      {showRoleUpdateReloadModal && (
        <div className="fixed bottom-4 right-4 z-[99999] flex w-[calc(100vw-2rem)] max-w-sm flex-col gap-3 sm:bottom-5 sm:right-5 animate-in fade-in slide-in-from-bottom-5 duration-300">
          <div className="overflow-hidden rounded-2xl border border-red-100/60 bg-white/95 backdrop-blur-md shadow-2xl ring-1 ring-black/5 dark:border-slate-800 dark:bg-slate-900/95">
            {/* Top gradient indicator */}
            <div className="h-1 bg-gradient-to-r from-red-500 via-rose-500 to-primary" />

            <div className="flex items-start gap-4 p-5">
              {/* Circular Icon Container */}
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-red-50 text-red-600 dark:bg-red-950/50 dark:text-red-400 shadow-sm">
