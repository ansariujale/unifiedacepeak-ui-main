...
exports.CampaignSchema.index({ name: "text", dialMethod: "text", campaignStatus: "text" });
exports.CampaignSchema.index({
    createdById: 1,
    created_at: -1
});


//# sourceURL=webpack://campaign-api/./src/models/CampaignModel.ts?
}